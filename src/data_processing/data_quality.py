...
parent_dir = os.path.dirname(current_dir) # /Users/filalidhia/projectTransportDefense/src
root_dir = os.path.abspath(os.path.join(current_dir, "../../"))
if root_dir not in sys.path:
    sys.path.append(root_dir)

from src.configuration.config import DATA_LAKE
from src.utils.data_lake_utils import check_file_exists, read_json_from_data_lake
